...
'This module has been developed by unknown to me author (downloaded sometime ago from psc)
...
Public Function Base64Encode(ByVal NormalString As String, Optional ByVal Break As Integer = 0) As String
